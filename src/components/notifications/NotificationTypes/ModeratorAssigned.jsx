...
function ModeratorAssigned({ notification, onMarkAsRead, onDelete }) {
    ...
    return (
        <div className={`p-4 border-l-4 border-l-blue-500 bg-white rounded-r-lg hover:bg-gray-50 transition duration-200 ${
...
export default ModeratorAssigned;