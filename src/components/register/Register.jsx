    ...
    const handleEmailRegister = async (e) => {
        ...
        try {
            ...
            await setDoc(doc(db, 'users', user.uid), {
                ...
                isDeleted: false,
                deletedAt: null,
                hasPassword: true, // IMPORTANTE: Marcar que SÍ tiene contraseña
                emailVerified: false,
                emailVerificationSentAt: new Date(),
                verificationExpiresAt: expiresAt, // Expira en 24 horas
                verificationAttempts: 1,
                provider: 'email' // Marcar que es registro por email
            });
        ...
        <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
            ...
            <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                <p className="text-sm text-blue-700 text-center">
                    <strong>Nota:</strong> 
                    <br />
                    • Las cuentas no verificadas se eliminan automáticamente después de 24 horas.
                    <br />
                    • Para registrarte con Google, ve a "Iniciar Sesión" y usa la opción de Google.
                </p>
            </div>
        </div>
    );
